...
class Dashboard:
    ...
    def logout(self):
        ...
        login = Login(root, cursor)  # Pass the Tk instance and cursor to the Login class
        root.mainloop()
    ...
    def logout(self):
        self.root.destroy()
        self.cursor.destroy()  # Close the current window, i.e., the admin dashboard
        root = Tk()
        root.title('LOGIN')
        root.geometry('1300x500+200+140')
        root.resizable(False, False)
